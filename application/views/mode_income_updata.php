            ...
            <?php //if(isset($data->id)) echo 'hii'; print_r($data);?>
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control"  name="name" id="exp_mode_name" value="<?php echo $data[0]->name;?>" required>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    ...
                    <textarea class="form-control"  name="description" id="exp_desc"> <?php echo $data[0]->description;?></textarea>
                  </div>
                </div>
                 <div class="form-group">
