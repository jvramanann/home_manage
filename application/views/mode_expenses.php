              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php 
                  ...
                  <td>
                      ...
                      <a href="<?php echo base_url().'budjet/mode_expenses_update/'.$val->id;?>"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;
                      <a href="<?php echo base_url().'budjet/exp_mode_delete/'.$val->id;?>"><i class="fa fa-trash"></i></a>&nbsp;&nbsp;&nbsp;
                  </td>
                </tr>
                <?php } ?>
